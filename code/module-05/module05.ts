...
class BuildArray {
    ...
    private _sortingOrder: 'ascending' | 'descending';
    // TODO Define the constructor
    constructor(items: number, sortingOrder: 'ascending' | 'descending') {
        this._items = items;
    ...
    set sortingOrder(sortingOrder: 'ascending' | 'descending') {
        this._sortingOrder = sortingOrder;
    }
    ...
    private ascending = (a: number, b: number) => {
        if (a > b) {
            return 1;
        } else if (b > a) {
            return -1;
